...
use DB;
class HomePageGoldRateSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
          // Insert data into the "home_pages_gold_rate" table using raw SQL query
          DB::table('home_pages_gold_rate')->insert([
            ...
            <div style="background-color:#04aa6d; color:white; padding:10px 20px; text-align:center">Live Gold and Silver Rate in Pakistan</div>
            ...
            <div style="background-color:#04aa6d; color:white; padding:10px 20px; text-align:center">Gold Rate in Pakistan today&nbsp;<strong>9 December 2023</strong></div>
            ...
            <div style="background-color:#04aa6d; color:white; padding:10px 20px; text-align:center">1 Tola Gold Price Today (9 December 2023)</div>
            ...
            <div style="background-color:#04aa6d; color:white; padding:10px 20px; text-align:center">Gold Price Today In Major Cities Of Pakistan</div>
