                    ...
                    <div class="col-12">
                       ...
                       @if(session('error'))
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ url('add-banner-ads') }}" enctype='multipart/form-data' method="post" id="myForm" class="drozone">
                                 @csrf
                                        <!--<div class="col-md-12">-->
                                        <!--    <div class="mb-3">-->
                                        ...
                                        <!--        <input id="website_link" required="" name="website_link" type="text" class="form-control">-->
                                        <!--    </div>-->
